...
export default function HeroSection(){
    return (
        <section className="relative bg-blue-50/70 pt-10 pb-16 px-4 sm:px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center lg:justify-between overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 z-20 pr-0 lg:pr-10 text-center lg:text-left mt-10 lg:mt-0">
                ...
                <div className="flex flex-col sm:flex-row w-full max-w-xl shadow-lg rounded-xl overflow-hidden border border-gray-200 mx-auto lg:mx-0">
                    ...
                    <button className="flex items-center justify-center bg-[#4b38ef] text-white px-8 py-4 font-semibold text-base sm:text-lg hover:bg-[#3f2fac] transition-colors whitespace-nowrap w-full sm:w-auto">
                        Book a Free Demo
                    </button>
                </div>
            </div>

            <div className="relative w-full h-[300px] sm:h-[400px] lg:w-1/2 lg:h-[550px] flex items-center justify-center z-10 mb-10 lg:mb-0">
                <div className="absolute top-1/4 left-1/4 w-6 h-6 sm:w-8 sm:h-8 bg-yellow-400 rounded-full opacity-70 filter blur-sm shadow-lg"></div>

                <div className="w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[470px] lg:h-[470px] rounded-full overflow-hidden flex items-center justify-center shadow-2xl relative">
                    <img
                ...
                <div className="absolute top-1/4 right-0 transform translate-x-1/2 -translate-y-1/2 p-2 sm:p-3 bg-white rounded-full shadow-lg">
                    <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500" fill="currentColor" />
                </div>
                <div className="absolute bottom-1/4 left-0 transform -translate-x-1/2 translate-y-1/2 p-2 sm:p-3 bg-white rounded-full shadow-lg">
                    <ThumbsUp className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" fill="currentColor" />
                </div>
            </div>
